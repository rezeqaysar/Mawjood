...
const ar = {
  ...
  trashTabMeta: '{count} ملاحظة · ضايل {days} يوم',
  ...
  restorePickTitle: 'رجّع على…',
  deletedTabGone: 'تبويب محذوف',
  back: 'رجوع',
  loading: 'عم بحمّل…',
...
const en: Record<keyof typeof ar, string> = {
  ...
  trashTabMeta: '{count} notes · {days} days left',
  ...
  restorePickTitle: 'Restore to…',
  deletedTabGone: 'deleted tab',
  back: 'Back',
  loading: 'Loading…',
  // secret vault tab (hidden)
