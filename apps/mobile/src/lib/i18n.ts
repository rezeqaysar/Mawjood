...
const ar = {
  ...
  // ── ghost key: master key + duress decoy + management ──
  masterKey: 'كلمة الماستر',
  masterHint: 'كلمة وحدة بتفتح إدارة مخازنك السرية. احفظها براسك — ما بتنكتب بمحل، حتى احنا ما بنشوفها.',
  masterNewPh: 'اختار كلمة الماستر…',
  masterCurrentPh: 'كلمة الماستر الحالية',
  masterSaved: 'تم حفظ كلمة الماستر ✓',
  masterChanged: 'تغيّرت كلمة الماستر ✓',
  masterWrong: '❌ كلمة غلط',
  masterTriesLeft: 'محاولات باقية',
  masterLocked: '🔒 انقفلت المحاولات لمدة ساعة — جرب بعدين',
  masterForgot: 'نسيت الكلمة؟',
  masterRecoverReq: 'طلب استرجاع كلمة الماستر',
  masterRecoverActive: '⏳ طلب استرجاع نشط',
  masterRecoverWait: 'بتقدر تحط كلمة جديدة بعد انتهاء المدة.',
  masterRecoverCancel: 'إلغاء طلب الاسترجاع',
  masterRecovered: 'تم تعيين كلمة ماستر جديدة ✓',
  masterRecoverTooEarly: '❌ لسا ما خلصت مدة الاسترجاع',
  masterIsVaultCode: '❌ هاي كلمة مخزن — اختار كلمة ثانية للماستر',
  vaultIsMasterCode: '❌ هاي كلمة الماستر — اختار كلمة ثانية للمخزن',
  duressKey: 'كلمة الطوارئ',
  duressHint: 'كلمة بتفتح مخزن وهمي فاضي — لليوم الأسود. ما بتستهلك من حد المخازن.',
  duressPh: 'اختار كلمة الطوارئ…',
  duressSaved: 'تم حفظ كلمة الطوارئ ✓',
  duressRemoved: 'انحذفت كلمة الطوارئ',
  duressRemove: 'إزالة',
  duressTaken: '❌ هاي الكلمة مستخدمة لمخزن ثاني',
  mgmtTitle: 'إدارة المخازن السرية',
  mgmtVaults: 'مخازنك',
  mgmtDecoy: '🎭 طُعم',
  mgmtNotes: 'ملاحظة',
  mgmtChangeCode: 'تغيير الكلمة',
  mgmtNewCodePh: 'كلمة جديدة…',
  mgmtCodeChanged: 'تغيّرت الكلمة ✓',
  ...
  menuFamilies: 'عيلتي',
  familyWord: 'عائلة',
  renameFamily: 'تسمية العيلة',
  renameHint: 'الاسم بيظهر لكل أعضاء العيلة.',
  renameEmpty: 'اكتب اسم العيلة أولاً',
  familyNamePh: 'مثال: عيلة الديرية',
...
const en: Record<keyof typeof ar, string> = {
  ...
  masterHint: 'One word that opens your secret vaults management. Keep it in your head — it is never written down, not even we can see it.',
  masterNewPh: 'Choose a master key…',
  masterCurrentPh: 'Current master key',
  masterSaved: 'Master key saved ✓',
  masterChanged: 'Master key changed ✓',
  masterWrong: '❌ Wrong key',
  masterTriesLeft: 'tries left',
  masterLocked: '🔒 Tries locked for one hour — try later',
  masterForgot: 'Forgot the key?',
  masterRecoverReq: 'Request master key recovery',
  masterRecoverActive: '⏳ Recovery request active',
  masterRecoverWait: 'You can set a new key once the wait ends.',
  masterRecoverCancel: 'Cancel recovery request',
  masterRecovered: 'New master key set ✓',
  masterRecoverTooEarly: '❌ Recovery waiting period is not over yet',
  masterIsVaultCode: '❌ That is a vault code — choose a different master key',
  vaultIsMasterCode: '❌ That is the master key — choose a different vault code',
  duressKey: 'Duress code',
  duressHint: 'A code that opens an empty decoy vault — for a bad day. It never uses a vault slot.',
  duressPh: 'Choose a duress code…',
  duressSaved: 'Duress code saved ✓',
  duressRemoved: 'Duress code removed',
  duressRemove: 'Remove',
  duressTaken: '❌ This code is already used by another vault',
  mgmtTitle: 'Secret vaults management',
  mgmtVaults: 'Your vaults',
  mgmtDecoy: '🎭 decoy',
  mgmtNotes: 'notes',
  mgmtChangeCode: 'Change code',
  mgmtNewCodePh: 'New code…',
  mgmtCodeChanged: 'Code changed ✓',
  ...
  renameHint: 'The name shows to all family members.',
  renameEmpty: 'Type the family name first',
  familyNamePh: 'e.g. The Direya family',
